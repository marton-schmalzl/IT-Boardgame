...
export const employees: Programmer[] = [
    ...
    },
    {
        ...
        cost: 3,
        text: {en: "When assigned to an Open Source Technology assignment: ➕💡,➕⚙️,➕📋"},
    ...
    },
    {
        ...
        cost: 2,
        text: {en: "When completing an assignment with 📋(organization) requirement of 4 or higher gain an extra Prestige"},
    ...
    },
    {
        ...
        cost: 6,
        text: {en: "All junior developers assigned to this project gain:➕⚙️,➕📋,➕💡"},
    ...
    },
    {
        ...
        cost: 3,
        text: {en: "When assigned alongside a senior employee gain: ➕💡➕⚙️➕📋"},
